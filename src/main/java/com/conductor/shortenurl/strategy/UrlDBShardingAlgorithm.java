 ...
 */
public class UrlDBShardingAlgorithm extends CustomShardingAlgorithm implements PreciseShardingAlgorithm<String> {
     ...
     *                             中解析出的分片健的值
     */
    // insert into url_mapping values('123abc',"www.baidu.com/xxxx.html")
    @Override
